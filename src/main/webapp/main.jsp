...
List<Product> saleProductList = productDao.selectProductsOnSale();
List<Product> newProductList = productDao.selectNewProducts();
...
%>
	...
	<!-- 
	 ...
	 -->   
	<div>
	<div class="row mb-5 mt-5" style="margin: 0 20px 0">
		<div class="col-3">
